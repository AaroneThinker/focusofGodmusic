               ...
               <ul id="iq-sidebar-toggle" class="iq-menu">
                  ...
                  <li>
                     ...
                     <ul id="admin" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        ...
                        <li><a href="admin-category.php"><i class="ri-function-line"></i>Genre</a></li>
                        <li><a href="admin-writer.php"><i class="las la-user"></i>Album</a></li>
                        <li><a href="admin-singer.php"><i class="las la-microphone-alt"></i>Artist</a></li>
